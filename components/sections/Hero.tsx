...
const words = ['private.', 'rare.', 'absolute.']
...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(to right, rgba(6,9,15,1) 0%, rgba(6,9,15,1) 10%, rgba(6,9,15,0.9) 22%, rgba(6,9,15,0.6) 40%, rgba(6,9,15,0.2) 60%, rgba(6,9,15,0) 76%)',
            zIndex: 2,
          }}
        />
      ...
      >
        <div style={{ maxWidth: 580 }}>
          ...
          >
            ...
            <span className="section-label">Dubai · Private Concierge</span>
          </motion.div>
          ...
          >
            We orchestrate every detail of your extraordinary life.<br />
      ...
      >
        <span style={{
          fontFamily: 'var(--font-tenor)', fontSize: 9,
