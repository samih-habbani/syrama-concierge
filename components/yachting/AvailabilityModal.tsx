          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                placeholder="e.g. 8"
                className="w-full bg-[#f5eedd] border border-[#b8974a]/25 hover:border-[#b8974a]/50 focus:border-[#b8974a] rounded-lg px-4 py-3 text-[#06090f] focus:outline-none transition text-sm placeholder-gray-600"
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-[#f5eedd] border border-[#b8974a]/25 hover:border-[#b8974a]/50 focus:border-[#b8974a] rounded-lg px-4 py-3 text-[#06090f] focus:outline-none transition text-sm"
                style={{ colorScheme: 'light' }}
                required
              />
            </div>
