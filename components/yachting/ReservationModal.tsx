              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={formData.date}
                    onChange={handleChange}
                    className="w-full bg-white/5 border border-[#b8974a]/25 hover:border-[#b8974a]/50 focus:border-[#b8974a] rounded-lg px-4 py-3 text-white focus:outline-none transition text-sm"
                    required
                  />
                </div>
